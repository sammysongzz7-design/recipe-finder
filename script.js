...
// /*
//     The application works completely with the local
//     Nigerian recipe dataset below.

//     Keep this false unless you have a verified NIFODA
...
//             <button
//                 class="delete-fav-btn fav-btn saved"
//                 data-id="${meal.id}">
...
//         /*
//             Normal recipe card behaviour:
//             clicking Favourite again removes it.
//         */
...
/*
    The application currently works with the
    Nigerian recipe dataset below.

    Keep this false unless you have a verified
    NIFODA endpoint and API key.
*/
...
// ==========================================
// NORMALIZE EXISTING FAVOURITES
// ==========================================

/*
    Older versions of the project may have stored
    recipe IDs in a different format.

    Everything is converted to strings so that:

        "nigeria-001"

    and other stored IDs are handled consistently.
*/
